...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    ...
    Note:
        bcrypt has a 72-byte limit (after UTF-8 encoding). Passwords longer than 72 bytes
        are truncated to fit the limit.
    """
    # Truncate to bcrypt's 72-byte limit (by bytes, not characters)
