...
# Optional env flag to completely disable PyTorch imports.
# This is useful on systems where the global torch installation is broken
# (e.g. segfaults inside torch.cuda / pynvml) and we want to force DEMO mode.
DISABLE_TORCH = os.getenv("AGROVEE_DISABLE_TORCH", "0") == "1"

# Try to import torch - run in demo mode if unavailable or explicitly disabled
