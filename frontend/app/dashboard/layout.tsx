...
const navItems = [
  {
    href: "/dashboard",
    label: "Dashboard",
    subtitle: "Monitor insights and quick stats",
    icon: LayoutDashboard,
  },
  {
    href: "/dashboard/diagnose",
    label: "Diagnose",
    subtitle: "Analyze plant issues with AI support",
    icon: Camera,
  },
  {
    href: "/dashboard/chat",
    label: "AI Chat",
    subtitle: "Get instant agronomy answers",
    icon: MessageSquare,
  },
  {
    href: "/dashboard/community",
    label: "Community",
    subtitle: "Connect & learn with other farmers",
    icon: Users,
  },
  {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <header className="flex h-auto min-h-14 flex-wrap items-center gap-4 border-b border-border/60 px-4 py-3 lg:min-h-[4.5rem] lg:px-8">
          {/* Mobile menu button */}
          <button className="lg:hidden" onClick={() => setSidebarOpen(true)}>
            <Menu className="h-5 w-5 text-foreground" />
          </button>
          <div className="flex flex-1 flex-col">
            <span className="font-heading text-base font-bold text-primary lg:text-2xl">
              {heroTitle}
            </span>
