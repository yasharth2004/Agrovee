...
export const communityAPI = {
  createPost: (
    ...
    return api.post<CommunityPost>("/community/posts", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    })
  },
  
  listPosts: (category = "all", search = "", skip = 0, limit = 20) =>
    api.get<CommunityPost[]>("/community/posts", {
  ...
  createComment: (postId: string, content: string) =>
    api.post<CommunityComment>(`/community/posts/${postId}/comments`, { content }),
